var labels = {
    ...
    "HEAD_UPCOMING_COURSES": {
        "vi-VN": "Các khóa học sắp khai giảng (Quý khách hàng vui lòng liên hệ <button type='button' class='btn btn-primary' data-bs-toggle='modal' data-bs-target='#addressModal'> văn phòng công ty </button> để đăng ký)",
        "en-US": "Upcoming courses (please contact <button type='button' class='btn btn-primary' data-bs-toggle='modal' data-bs-target='#addressModal'> the company office </button> for registration)",
    },
    "COPYRIGHT": {
